...
<head>
  ...
  <title>Cauvery College Management - Student Register</title>
      ...
      <div class="container">
        ...
        <div class="row g-0" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
            <form action="model/student_register.php" method="post" >
              <!--<h3>Get a quote</h3>
              ...
              <div class="row gy-4">
                ...
                <div class="col-12 text-center">
                  ...
                  <button type="submit" class="btn-getstarted1" name="student_register">Register</button><br><br>
