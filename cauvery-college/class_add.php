...
<head>
  ...
  <title>Student Profile Application - Admin Class Add</title>
    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="faculty_view.php">Faclty</a></li>
  ...
  <main class="main">
    ...
    <div class="page-title dark-background" data-aos="fade" style="background-image: url(assets/img/page-title-bg.jpg);">
      <div class="container position-relative">
        <h1>Admin Class Add</h1>
        <!--<p>Esse dolorum voluptatum ullam est sint nemo et est ipsa porro placeat quibusdam quia assumenda numquam molestias.</p>-->
        <nav class="breadcrumbs">
          <ol>
            <li><a href="index.php">Home</a></li>
            <li class="current">Admin Class Add</li>
      ...
      <div class="container">
        ...
        <div class="row g-0" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
            <form action="model/class_add.php" method="post" >
              <!--<h3>Get a quote</h3>
              ...
              <div class="row gy-4">
                ...
                <div class="col-lg-12">
                  <center><h3>Add Class Details</h3><br>
				  <div class="container">
				  ...
				  <div class="col-3">
					  ...
					  <select name="faculty_id" id="faculty_id" class="form-control show-tick" required>
						<option value="">Faculty Name</option>
						<?php 
						
							$sql=mysqli_query($conn,"select * from faculty order by faculty_name asc");
				  ...
				  <div class="col-3">
					  ...
					  <div class="col-6">
						 <label>Class Strength</label><br><br>
					  <input type="text" name="strength" class="form-control" placeholder="Class Strength" required="">
					</div>
					<div class="col-3">
				  </div>
				  <div class="col-3">
				  ...
				  <button type="submit" class="btn-getstarted1" name="class_add">Add</button><br><br>
				  </div>
				  <div class="col-3">
				  </div>
				  </div>
