...
<head>
  ...
  <title>Student Profile Application - Student Login</title>
      ...
      <div class="container">
        ...
        <div class="row g-0" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
            <form action="model/student_login.php" method="post" >
              <!--<h3>Get a quote</h3>
              ...
              <div class="row gy-4">
                ...
                <div class="col-12 text-center">
                  ...
                  <button type="submit" class="btn-getstarted1" name="student_login">Login</button><br><br>
				  
				  <a href="student_register.php" class="btn-getstarted1" name="student_login">Create a New Account</a>
                </div>
