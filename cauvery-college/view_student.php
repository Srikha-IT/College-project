				  ...
				  <center>
				   ...
				   <tr>
					  <?php
						...
						$i=0;
						$sql = mysqli_query($conn,"select * from student where student_id=".$_GET['student_id']."");
						...
						<tr>
						  <td>Name  </td><td> : <?php echo $row['first_name']."".$row['last_name'];?></td>
						</tr>
						<tr>
						  <td>DOB  </td><td> : <?php echo $row['dob'];?></td>
						</tr>
						<tr>
						  <td>Scholer Type  </td><td> : <?php echo $row['type'];?></td>
						</tr>
						<tr>
						  <td>Register No  </td><td> : <?php echo $row['regno'];?></td>
						</tr>
						<tr>
						  <td>Program  </td><td> : <?php echo $row['program'];?></td>
						</tr>
						<tr>
						  <td>Class </td><td> : <?php echo $row['class_section'];?></td>
						</tr>
						<tr>
						  <td>Year of Study </td><td> : <?php echo $row['year_of_study'];?></td>
						</tr>
						<tr>
						  <td>Department </td><td> : <?php echo $row['department'];?></td>
						</tr>
						<tr>
						  <td>Blood Group </td><td> : <?php echo $row['bloodgroup'];?></td>
						</tr>
						<tr>
						  <td>Father Name </td><td> : <?php echo $row['father_name'];?></td>
						</tr>
						<tr>
						  <td>Mother Name </td><td> : <?php echo $row['mother_name'];?></td>
						</tr>
						<tr>
						  <td>Mobile </td><td> : <?php echo $row['mobile'];?></td>
						</tr>
						<tr>
						  <td>Address </td><td> : <?php echo $row['residental_address'];?></td>
						</tr>
