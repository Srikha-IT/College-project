...
<head>
  ...
  <title>Student Profile Application - Admin Class</title>
      ...
      <div class="container position-relative">
        ...
        <nav class="breadcrumbs">
          <ol>
            ...
            <li class="current">Admin Class</li>
          ...
          <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
            <form action="model/admin_login.php" method="post" >
              ...
              <div class="row gy-4">
                ...
                <div class="col-lg-12">
                  <center><h3>Class Details  <a href="class_add.php">ADD </a></h3><br>
		 <div class="container">
		 <?php 
			  ...
			  <?php
			    ...
			    $i=0;
			    $sql = mysqli_query($conn,"select * from class cls LEFT JOIN faculty fac ON cls.faculty_id=fac.faculty_id");
