...
<head>
  ...
  <title>Student Profile Application - Faculty Register</title>
...
<body class="get-a-quote-page">
      ...
      <div class="container position-relative">
        ...
        <nav class="breadcrumbs">
          <ol>
            ...
            <li class="current">Faculty Register</li>
          </ol>
        </nav>
      </div>
    </div><!-- End Page Title -->
      ...
      <div class="container">
        ...
        <div class="row g-0" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
            <form action="model/faculty_register.php" method="post" >
              <!--<h3>Get a quote</h3>
              ...
              <div class="row gy-4">
				...
				<label>Faculty Name</label><br><br>
                  <input type="text" name="faculty_name" class="form-control" placeholder="First Name" required="">
                </div>
				...
				<label>Email</label><br><br>
                  <input type="email" class="form-control" onkeyup="email_verify(this.value)" name="email" placeholder="Email" required="">
				  <span id="email_info"></span>
                </div>

                <div class="col-6">
				<label>Mobile Number</label><br><br>
                  <input type="text" class="form-control" onkeypress="return isNumber(event)" onkeyup="verify_mobile(this.value)" name="mobile" placeholder="Phone" required="">
                ...
                <div class="col-12 text-center">
                  ...
                  <button type="submit" class="btn-getstarted1" name="faculty_register">Register</button><br><br>
				  <a href="faculty_login.php" class="btn-getstarted1" name="faculty_login">Already have a Account?</a>
                </div>
  ...
  <script>
    ...
    function email_verify(email) 
	{
			...
			if(email=='')
			{
				$("#email_info").css("color", "red").html("Enter the Email ID");
			}
			
			
			else if (regex.test(email) == false) 
			{
				$("#email_info").css("color", "red").html("<span style='padding-top:10px;'>Enter Your Right Email ID</span>");
				$("#email").val('');
			}
			else
			{
	...
	function verify_mobile(id) 
	{
		...
		if(mobile=='')
		{
			$("#mobile_info").css("color", "red").html("Enter the Mobile Number");
		}
		else if(mobile.length!=10)
		{
			$("#mobile_info").css("color", "red").html("<span style='padding-top:10px;'>Invalid 10 Digit Mobile Number  </span>");
		}
		
		/*else if (reg.test(mobile).css("color", "red") == false) 
		{
			$("#mobile_info").css("color", "red").html("<span style='padding-top:10px;'>Invalid Mobile Number</span>");
			$("#mobile").val('');
		}*/
